...
func TestCleanContentPassesThroughExistingPointer(t *testing.T) {
	...
	if err := WriteObject(common.DRS_OBJS_PATH, &drsapi.DrsObject{
		Size: 21,
	...
	if cachePath, err := ObjectPath(common.LFS_OBJS_PATH, contentOID); err == nil {
